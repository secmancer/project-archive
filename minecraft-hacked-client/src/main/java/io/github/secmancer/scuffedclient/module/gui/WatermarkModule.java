...
public class WatermarkModule extends Module {
	...
	private static final StringSetting line1=new StringSetting("First Line","line1","The first line of text.",()->true,"ScuffedClient");
	private static final StringSetting line2=new StringSetting("Second Line","line2","The second line of text.",()->true,"Minecraft Hacked Client");
	private static final StringSetting line3=new StringSetting("Third Line","line3","The third line of text.",()->true,"Made by secmancer");
	...
	public static IFixedComponent getComponent() {
		return new ListComponent(()->"Watermark",new Point(350,219),"watermark",new HUDList() {
			@Override
			public int getSize() {
				return 3;
			}
