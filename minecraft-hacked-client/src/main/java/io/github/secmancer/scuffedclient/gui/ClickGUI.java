...
import io.github.secmancer.scuffedclient.module.util.Category;
...
import io.github.secmancer.scuffedclient.module.gui.ClickGUIModule.Theme;
...
public class ClickGUI extends MinecraftHUDGUI {
	...
	public static final int WIDTH=60,HEIGHT=12,DISTANCE=6,BORDER=2;
	...
	public ClickGUI() {
		...
		gui.addHUDComponent(StatsModule.getComponent(inter), StatsModule.getToggle(),animation.get(),theme,BORDER);
